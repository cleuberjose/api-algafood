...
public class ProdutoController {
	...
	@GetMapping
	public List<ProdutoModel> listar(@PathVariable Integer idRestaurante) {
		Restaurante restaurante= cadastroRestauranteService.buscarOuFalhar(idRestaurante);
		return produtoModelAssembler.toCollectionsModel(cadastroProdutoService.listar(restaurante));
	}
